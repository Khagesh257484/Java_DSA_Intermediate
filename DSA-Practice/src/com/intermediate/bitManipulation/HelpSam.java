...
/*  Hints :
  if you can observe it is nothing but just count the number of set bits in number

* */
package com.intermediate.bitManipulation;

public class HelpSam {
    public static int sameHelp(int n) {
        int count = 0;
        for (int i = 0; i < 31; i++) {
            if (((n >> i) & 1) == 1)
                count++;
    ...
    public static void main(String[] args) {
        System.out.println(sameHelp(5));
        System.out.println(sameHelp(3));
        System.out.println(sameHelp(21));
    }
}
